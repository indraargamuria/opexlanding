...
// .wrangler/tmp/pages-6fVJbs/functionsWorker-0.20516528747665763.mjs
...
var onRequestDelete = /* @__PURE__ */ __name2(async ({ env, params, request }) => {
  if (!await isAdmin(request, env)) return err("unauthorized", 401);
...
var onRequestDelete2 = /* @__PURE__ */ __name2(async ({ env, params, request }) => {
  if (!await isAdmin(request, env)) return err("unauthorized", 401);
  const id = Number(params.id);
...
var onRequestGet6 = /* @__PURE__ */ __name2(async ({ env }) => {
  try {
    const { results } = await env.DB.prepare(
...
// .wrangler/tmp/bundle-CETWyJ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-CETWyJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.20516528747665763.js.map
